...
router.get('/', function (req, res) { 
    res.render('index', { title: 'IceCreame App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'IceCreame App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'IceCreame App Login', user : req.user }); 
}); 
